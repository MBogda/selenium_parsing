...
var country_dom = (digitalData.page.pageInfo.geoRegion != null) ? digitalData.page.pageInfo.geoRegion : "";
var org = (digitalData.page.category.organization != null) ? digitalData.page.category.organization : "";
var attr_country = (digitalData.page.attributes.country != null) ? digitalData.page.attributes.country : "";
var lang = (digitalData.page.pageInfo.language != null) ? digitalData.page.pageInfo.language : "";
var is_dd_set = (digitalData != null);
...
+",ticketexchangebyticketmaster.com,sap.com,livenationentertainment.com,houseofblues.com,beats.mu";
...
var overEventListThreshold = function(currentEventListArray) {
var eventListThreshold = 40;
return currentEventListArray.length > eventListThreshold;
};
var trimEventList = function(currentEventListArray) {
return currentEventListArray.slice(1).join();
}
var currentEventListArray = tm_omn.currentEventList.split(',');
if (overEventListThreshold(currentEventListArray)) {
tm_omn.currentEventList = trimEventList(currentEventListArray);
}
...
if(tm_omn.eVar40)
{
tm_omn.firstcolon=tm_omn.eVar40.indexOf(':')
tm_omn.tempdomain=tm_omn.eVar40.substring(0,tm_omn.firstcolon);
tm_omn.secondcolon=tm_omn.eVar40.indexOf(':',tm_omn.firstcolon+1);
tm_omn.artistID=tm_omn.eVar40.substring(tm_omn.firstcolon+1,tm_omn.secondcolon);
tm_omn.venueID=tm_omn.eVar40.substring(tm_omn.secondcolon+1,tm_omn.eVar40.length);
if(tm_omn.artistID==tm_omn.eVar17||tm_omn.venueID==tm_omn.eVar16)
tm_omn.eVar40=tm_omn.tempdomain;
else
tm_omn.eVar40=tm_omn.prop17;
}
else
tm_omn.eVar40=tm_omn.prop17;
}
...
{
if(!ep || ep != 1)
var isFirstPage=tm_omn.getVisitStart("s_visit");
if(ep == 1 || isFirstPage == 1)
{
var dviCookie=tm_omn.c_r('s_vi');
...
if(ep == 1 || isFirstPage == 1)
{
var dviCookie=tm_omn.c_r('lns_vi');
var visRegExp=/[0-9A-F]+-[0-9A-F]+/g;
var dvi=dviCookie.match(visRegExp);
var pr=location.protocol;
var du=pr+'//fls.doubleclick.net/activityi;src='+ds+';type='+dt+';cat='+dc+';'+dn+'=';
...
+"w,s;if(wd.s_c_il){s=wd.s_c_il['+s._in+'];s.bcr();s.mrq(\"'+un+'\");s.nrs--;if(!s.nrs)s.m_m(\"rr\")}');if(!s.nrs){s.nrs=1;s.m_m('rs')}else s.nrs++;if(org!=\"LN\" && attr_country!=\"US\" && lang!=\"en-us\" && country_dom!=\"us\" && country_dom!=\"ca\" && country_dom!=\"mx\"){im.src=rs;}if(s.useForcedLinkTracking||s.bcf){if(!s."
+"forcedLinkTrackingTimeout)s.forcedLinkTrackingTimeout=250;setTimeout('if(window.s_c_il)window.s_c_il['+s._in+'].bcr()',s.forcedLinkTrackingTimeout);}else if((s.lnk||s.eo)&&(!ta||ta=='_self'||ta=='_"
+"top'||ta=='_parent'||(s.wd.name&&ta==s.wd.name))){b=e=new Date;while(!im.s_l&&e.getTime()-b.getTime()<500)e=new Date}return ''}var pixel_src='';if(org!=\"LN\" && attr_country!=\"US\" && lang!=\"en-us\" && country_dom!=\"us\" && country_dom!=\"ca\" && country_dom!=\"mx\"){pixel_src='src=\"'+rs+'\"';}return '<im'+'g '+pixel_src+' width=1 height=1 border=0 alt=\"\">'"
